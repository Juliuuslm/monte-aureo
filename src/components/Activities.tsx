      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {activities.map((activity, index) => (
            <div
              key={index}
              className="bg-white p-3 shadow-lg transform hover:scale-105 transition-all duration-300 hover:shadow-xl"
              style={{
                transform: `rotate(${index % 2 === 0 ? (index % 3 === 0 ? -2 : 2) : index % 3 === 0 ? -3 : 3}deg)`
              }}
            >
